...
![CI/CD overview placeholder](/images/codepipeline-1.png)
2. Trong tab pipeline settings, đặt tên pipeline và dùng các thiết lập mặc định.
![CI/CD overview placeholder](/images/codepipeline-2.png)
3. Bật webhook events và thêm bộ lọc theo tag. Đặt mẫu tag là "v*".
![CI/CD overview placeholder](/images/codepipeline-3.png)
4. Thêm dự án frontend/backend bằng AWS CodeBuild ở bước Build.
![CI/CD overview placeholder](/images/codepipeline-4.png)
